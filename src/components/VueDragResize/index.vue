...
function addEvents(events, parentElement) {
  events.forEach((cb, eventName) => {
    parentElement.addEventListener(eventName, cb);
  });
}

function removeEvents(events, parentElement) {
  events.forEach((cb, eventName) => {
    parentElement.removeEventListener(eventName, cb);
  });
}
...
export default {
  ...
  mounted() {
    ...
    addEvents(this.domEvents, this.parentElement);
  ...
  beforeUnmount() {
    removeEvents(this.domEvents, this.parentElement);
  },
